...
class InstructorasAutorizadas extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <h1>Instructoras Autorizadas</h1>
                {this.state.instructoras.map(instructora => {
                    return <InstructoraObject key={instructora.telefono} instructora={instructora} approvedHandle={this.handleAprobacion} autorizada={true}/>
                })}
            </div>
        )
    }
...
export default InstructorasAutorizadas;